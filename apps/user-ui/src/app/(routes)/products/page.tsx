...
const page = () => {
  ...
  const toogleColor = (color: string) => {
          ...
          <aside className="w-full lg:w-[270px] !rounded bg-white p-4 space-y-6 shadow-md">
              ...
              <Range
                ...
                renderTrack={({ props, children }) => {
                  ...
                  return (
                    <div
                      {...props}
                      className="h-[6px] bg-blue-200 rounded realtive"
                      style={{ ...props.style }}
                    >
                      <div
            ...
            <div className="flex justify-between items-center mt-2">
              ...
              <button
                ...
                className="text-sm px-4 py-1 bg-gray-200 hover:bg-blue-600 hover:text-white transistion !rounded"
              >
                Apply
              </button>
            </div>
                ...
                >
                  <label className="flex items-center gap-2 cursor-pointer text-sm">
                    <input
                      ...
                      onChange={() => toogleColor(color.name)}
                      className="accent-blue-600"
                    />
                    <span
